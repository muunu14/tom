  ...
  return (
    <div className="w-full h-[1140px] pt-24 pr-20 pb-24 pl-20 flex items-center justify-center  max-sm:w-[375px] max-sm:h-[1616px]   max-sm:pr-4 max-sm:pl-40">
      <div className="w-[1280px] h-[948px] pr-8 pl-8 flex flex-col gap-12 items-center max-sm:w-[343px] max-sm:h-[680px] max-sm:flex max-sm:flex-col max-sm:gap-10  ">
        ...
        <div className="w-[896px] h-[288px] rounded-xl p-8 flex justify-center items-center  max-sm:w-[343px] max-sm:h-[372px] shadow-2xl ">
          <div className="w-[832px] h-[224px] flex flex-row gap-12 justify-between max-sm:w-[279px] max-sm:h-[308px] max-sm:flex max-sm:flex-col max-sm:gap-4  ">
            ...
            <div className="w-[146px] h-[24px] font-normal text-[16px]  justify-end max-sm:hidden">
              Nov 2021 - Present
            </div>
          </div>
        </div>
        <div className="w-[896px] h-[264px] rounded-xl p-8  flex justify-center items-center max-sm:w-[343px] max-sm:h-[348px]  shadow-2xl">
          <div className="w-[832px] h-[200px] flex flex-row gap-12 justify-between max-sm:w-[279px] max-sm:h-[284px] max-sm:flex max-sm:flex-col max-sm:gap-4 ">
            ...
            <div className="w-[384px] h-[200px] flex flex-col gap-4 ">
              ...
              <div className="w-[384px] h-[156px] flex flex-col gap-1 rounded-2xl ">
                <div className="w-[384px] h-[24px] shadow-2xl font-normal text-[16px]  max-sm:w-[279px]">
                  • Sed quis justo ac magna.
                </div>
                <div className="w-[374px] h-[48px] font-normal  text-[16px]max-sm:w-[279px]">
                  • Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                </div>
                <div className="w-[384px] h-[24px] font-normal text-[16px max-sm:w-[279px]">
                  • Sed quis justo ac magna.
            ...
            <div className="w-[148px] h-[24px] font-normal text-[16px]  max-sm:hidden">
              Jul 2017 - Oct 2021
            </div>
          </div>
        </div>
        <div className="w-[896px] h-[180px] shadow-2xl rounded-xl p-8 flex justify-center items-center max-sm:w-[343px] max-sm:h-[300px] ">
          <div className="w-[832px] h-[116px] flex flex-row gap-12 justify-between max-sm:w-[279px] max-sm:h-[230px] max-sm:flex max-sm:flex-col max-sm:gap-4 ">
            ...
            <div className="w-[161px] h-[24px] font-normal text-[16px]  max-sm:w-[279px] max-sm:hidden">
              Dec 2015 - May 2017
            </div>
          </div>
        </div>
