    ...
    <div className="w-full h-[556px] flex flex-row gap-[80px] justify-center pt-[96px] pr-[80px] pb-[96px] pl-[80px]  max-sm:h-[904px] max-sm:pt-16 max-sm:pr-4 max-sm:pb-16 max-sm:pl-4 max-sm:flex max-sm:flex-col-reverse">
      <div className="w-[600px] h-[364px] flex flex-col gap-12 max-sm:w-full max-sm:h-[428px] max-sm:flex  ">
        <div className="w-[600px] h-[176px] flex flex-col gap-2 max-sm:w-full max-sm:h-[240px] max-sm:flex max-sm:flex-col max-sm:gap-2 ">
          ...
          <p className="w-[600px] h-[96px] font-normal text-[16px]  max-sm:w-full max-sm:h-[192px] max-sm:font-normal max-sm:text-[16px]">
            I specialize in full stack development, particularly with React.js
            and Node.js. My main goal is to create exceptional digital
            experiences that are fast, visually appealing, and accessible to
            everyone. With over 7 years of experience in web development, I
        ...
        <div className=" h-[56px] flex flex-col gap-2 max-sm:w-full max-sm:h-[56px] ">
          ...
          <div className="h-[24px] flex flex-row gap-2">
            <img src="ivon2.png" alt="" />
            <p className=" h-[24px] font-normal text-[16px] ">
              Available for new projects
            </p>
          </div>
        </div>
        <div className=" h-[36px] flex flex-row gap-4 items-center">
          ...
          <img className="w-[34px] h-[34px]" src="twit.png" alt="" />
          <img src="shuvuu.png" alt="" />
        </div>
      </div>
